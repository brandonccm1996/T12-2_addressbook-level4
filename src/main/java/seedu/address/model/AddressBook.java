...
public class AddressBook implements ReadOnlyAddressBook {
    ...
    private void removeTagFromPerson(Tag tag, Person person) {
        ...
        if (!newTags.remove(tag)) { // if this person does not have tag that user wants to remove, don't do anything
            return;
        }
    ...
    public void removeTag(Tag tag) {
        persons.forEach(person -> removeTagFromPerson(tag, person));    // internal iterator
    }
